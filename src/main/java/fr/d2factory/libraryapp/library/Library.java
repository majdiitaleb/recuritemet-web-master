...
public interface Library {
     ...
     * @see Member
     */
    Book borrowBook(BookRepository bookRepository, long isbnCode, Member member, LocalDate borrowedAt) throws HasLateBooksException;
     ...
     */
    void returnBook(BookRepository bookRepository,Book book, Member member);
}
